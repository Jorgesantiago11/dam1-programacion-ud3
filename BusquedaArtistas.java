...
public class BusquedaArtistas {
    ...
    private static String nombreBuscado() {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'nombreBuscado'");
    }
    ...
    public static int[] indicesPorInicialYSeguidores(Artista[] cartel, char inicial,
        ...
        char inicialower = Character.toLowerCase(inicial);
        int count = 0;
        for (int i = 0; i < cartel.length; i++) {
        ...
        int[] indice = new int[inicialower];
        int h = 0;
